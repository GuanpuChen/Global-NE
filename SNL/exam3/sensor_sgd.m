function [x1,x,XX,sigma_opt,round]= sensor_sgd(X0,sigma0,terminal,a,distance3)  %X0:(n,N), B:(n,N)
...
%              end
             ...
             for i =1:N
                 for l=1:N
                     if distance3(i,l)~=0 
                        dx(:,i)=dx(:,i)+4*((x(:,i,j)-x(:,l,j))'*(x(:,i,j)-x(:,l,j))-distance3(i,l)^2)*(x(:,i,j)-x(:,l,j))+randn;
                       % dsigma(c,1)=(x(:,i,j)-x(:,l,j))'*(x(:,i,j)-x(:,l,j))-distance3(i,l)^2-0.5*sigma(c,1,j);
                        %c=c+1;
                     end
                 end
                 for l=N+1:M
                     if distance3(i,l)~=0 
                        dx(:,i)=dx(:,i)+4*((x(:,i,j)-a(:,l))'*(x(:,i,j)-a(:,l))-distance3(i,l)^2)*(x(:,i,j)-a(:,l))+randn;
                     %   dsigma(c,1)=(x(:,i,j)-a(:,l))'*(x(:,i,j)-a(:,l))-distance3(i,l)^2-0.5*sigma(c,1,j);
                       % c=c+1;
                     end
                 end         
