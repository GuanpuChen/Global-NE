...
[tt,X_opt,sigma_opt,round]= sensor10(x_ini,sigma_ini,terminal,a,distance3) 
 %[x2,x,X_opt,sigma_opt,round]= sensor_pgd(x_ini,sigma_ini,terminal,a,distance3) 
% [x3,x,X_opt,sigma_opt,round]= sensor_sgd(x_ini,sigma_ini,terminal,a,distance3) 
%[x4,x,X_opt,sigma_opt,round]= sensor_pentalty(x_ini,sigma_ini,terminal,a,distance3) 
%[x5,x,X_opt,sigma_opt,round]= sensor_proximal(x_ini,sigma_ini,terminal,a,distance3)
